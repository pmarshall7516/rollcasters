...
check(loadoutErrorMessage(new Error("PLAYER_REVISION_CONFLICT: stale"), "fallback") === "This loadout changed elsewhere. The latest state is loaded; please try again.", "published loadout error codes should retain their mapped messages");
