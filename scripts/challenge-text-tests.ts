...
const cases: Array<[CollectibleUnlockChallenge, string]> = [
  ...
  [challenge("skill_arsenal" as never, { required_distinct_skills: 5, minimum_uses_per_skill: 2, required_completions: 1, tracking_scope: "single_encounter", skill_type: "attack", skill_tag_ids: ["final-stage"] }), "Use 5 different Final Stage-tagged attack Skills at least twice each in one encounter."],
