...
import { StarterRollcasterScreen, StarterScreen } from "./features/home/StarterScreens";
import {
  lootboxPoolEntryName,
  lootboxQuantity,
  lootboxRewardName,
  lootboxRewardProgress,
  type LootboxRewardProgressState,
} from "./features/bag/lootbox-presentation";
import { ShopEmptyState, ShopProgressBar, ShopQuantityControl } from "./features/shop/ShopPrimitives";
import { shardUnlockProgress } from "./features/shop/shop-presentation";
import {
  actionCostTone,
  buildXpAnimSegments,
  costBreakdownText,
  ...
  useLayoutEffect(() => {
    ...
    const fit = () => {
      ...
      animationFrame = window.requestAnimationFrame(() => {
        ...
        setSkillFontSize((current) => current === null && nextFontSize === null
